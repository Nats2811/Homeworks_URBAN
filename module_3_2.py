...
# Создайте функцию send_email, которая принимает 2 обычных аргумента: сообщение и получатель и 1 обязательно именованный аргумент со значением по умолчанию 
#  - отправитель.
...
def send_email(message, recipient, *, sender='university.help@gmail.com'):
    ...
    if recipient.endswith(('.com', '.ru', '.net')) == False or sender.endswith(('.com', '.ru', '.net')) == False:
        print(f'Невозможно отправить письмо с адреса {sender} на адрес {recipient}.')
